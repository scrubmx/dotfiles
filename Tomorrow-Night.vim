...
" Console 256 Colours
if !has("gui_running")
  " let s:background = "303030" <-- comented by scrub
	let s:window = "5e5e5e"
	let s:line = "3a3a3a"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("LineNr", s:selection, s.grey, "")
	call <SID>X("NonText", s:selection, "", "")
	call <SID>X("SpecialKey", s:selection, "", "")
	call <SID>X("Search", s:background, s:yellow, "")
	call <SID>X("TabLine", s:window, s:foreground, "")
	call <SID>X("TabLineFill", s:window, s:foreground, "")
